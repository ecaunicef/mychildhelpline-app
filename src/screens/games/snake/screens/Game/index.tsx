...
class Game extends React.Component<Props> {
    ...
    constructor(props: never) {
        ...
        makeObservable<
            Game,
            'isRunning' | 'setIsRunning' | 'gridSize' | 'cellSize' | 'boardSize'
        >(this, {
    ...
    render() {
        const { useSwipes, difficulty, theme, useTeleport } =
            ...
            >
                ...
                >
                    <GameEngine
                        ...
                        systems={[
                            GameLoop(this.gridSize, useSwipes, useTeleport),
                        ]}
